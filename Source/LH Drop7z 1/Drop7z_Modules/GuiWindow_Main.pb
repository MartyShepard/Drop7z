...
Module GUI00
    ...
    Procedure MakeWin()
    	...
    	GadgetToolTip(DC::#Button_002, "Konvertiere zu 7z: ZIP, RAR, TAR, KPF, PK3, PK4, TSU")    	
...
Module GUI04
    ...
    Procedure GuiObjects(ChangedX,ChangedY,WindowsX)
        ...
        StartDrawing(CanvasOutput(DC::#SkinCvas_002)): DrawImage(ImageID(DC::#SkinBase_002), 0, 0): StopDrawing()
