	...
	Procedure.s  GetPath_Config(LoadOption.i = 0)
		...
		Select LoadOption
			Case 1
				ProcedureReturn szCurrent + suSubData + szConfig   + szSuffix
			Case 2
				ProcedureReturn szCurrent + suSubData + szProfiles + szSuffix
			Case 3
				ProcedureReturn szCurrent + suSubData + szHistory  + szSuffix
		EndSelect
