...
Module DropSPak
   ...
   ;
    ...
    Procedure.i zConsoleOut_Ok(*P.PROGRAM_BOOT) 
        ...
        If (Len(*P\StError) >= 1 )
            Request::MSG( DropLang::GetUIText(20) , DropLang::GetUIText(29) , *P\StError, 2, 2, ProgramFilename())  
            ProcedureReturn 1
        EndIf
    ...
    Procedure.i Items_HideDirectory()
        ...
        For Itm = 0 To CountGadgetItems( DC::#ListIcon_001 )
        ...
        If ( Visible = CountGadgetItems( DC::#ListIcon_001 ) )
        ...
        If ( ListSize( *P\Collection() ) >= 1 )
            ...
            If ( ListSize( *P\Collection() ) = Max )
                Request::MSG( DropLang::GetUIText(20) , 
                              ...
                              DropLang::GetUIText(38) + #CR$ + "In: " + ListSize( *P\Collection() ) + "/ Out: " + Str(Max) , 2, 0, ProgramFilename())  
                ProcedureReturn 0
            EndIf
            ...
            If ( ListSize( *P\Collection() ) >= Max )
                ...
                Request::MSG( DropLang::GetUIText(20) , 
                              ...
                              DropLang::GetUIText(39) + #CR$ + "In: " + ListSize( *P\Collection() ) + "/ Out: " + Str(Max) + #CR$ + Lst, 2, 0, ProgramFilename()) 
                ProcedureReturn 1
            EndIf
        ...
        *P\DstPath         = GetGadgetText(DC::#String_002)      
        ...
        If  ( DropCode::GetDriveType( *P\DstPath ) = 5 )
            Request::MSG( DropLang::GetUIText(20) , 
                          ...
                          DropLang::GetUIText(28), 2, 0, ProgramFilename())            
