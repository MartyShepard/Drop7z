...
DeclareModule Request             
    ...
    Global *MsgEx.MsgReqEx = AllocateMemory(SizeOf(MsgReqEx)) 
    ...
    Declare.i MSG(Window_Title$ = "",
                  TopHead_Text$ = "",
                  Message_Text$ = "",
                  ButtonStyle.i = 2, Icon.i =  0, Icon_Program$ = "", sCheckBox.i = 0, sInput.i = 0,ParentID = 0)
  ...
  Module Request
      ...
      ;
      ;________________________________________________________________________________________________________________________________             
      Procedure MSG_Internal_Language(*MsgEx.MsgReqEx)
      ...
      Procedure MSG_Internal_SetBtn(*MsgEx.MsgReqEx)
          ...
          MSG_Internal_Language(*MsgEx.MsgReqEx)
      ...
      Procedure.i MSG(Window_Title$ = "",
                      TopHead_Text$ = "",
                      Message_Text$ = "",
                      ButtonStyle.i = 2, Icon.i =  0, Icon_Program$ = "", sCheckBox.i = 0, sInput.i = 0,ParentID = #Null)
          ...
          *MsgEx\WH = 60 + rFntPixH + rFntPixC + rFntPixS
          ...
          MSG_Internal_SetBtn(*MsgEx.MsgReqEx)
          MSG_Internal_Image()
          ...
          If (*MsgEx\Checkbox_On = 1)        
              ...
              SetWindowCallback(@MSG_Internal_CallBack()): SetGadgetState(#REXCBBTN,*MsgEx\CheckBox_En)
          EndIf
          ;
          ; ==================================================================================================================
        ...
        Repeat
            ...
            Select Event
                Case 1
                  ...
                  MessageText$ = "Fritzchen schreibt aus dem Ferienlager:"+
...
; EnableThread
; EnableXP
; UseIcon = ..\LH Game Database\Modules\Data_Images\Icon\Compicon programm.ico
